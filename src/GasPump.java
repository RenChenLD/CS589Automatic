public class GasPump {
	...
	public final float Show_price()
	{
//		System.out.println("Current prices of gasolines: "+this.price);
//		System.out.println("Regular: "+ this.Rprice);
//		System.out.println("Super: "+ this.Sprice);
//		System.out.println("Diesel: " + this.Dprice);
		return this.price;
	}
	
	public final void Show_state()
	{
		System.out.print("Rprice= "+this.Rprice+", Sprice= "+this.Sprice+", Dprice= "+this.Dprice+", w= "+this.w+", price= "+this.price+", L= "+this.L+", total= "+this.total+", cash="+this.cash);
		if(this.k==-1)
			System.out.println(", State= Start");
		else if(this.k==-2)
			System.out.println(", State= End");
		else
			System.out.println(", State= S"+this.k);
		System.out.println();
	}
}